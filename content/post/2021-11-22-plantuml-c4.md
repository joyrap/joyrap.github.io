...
最近工作中开始重度使用[PlantUML](https://plantuml.com)，于是就总结一下软件开发中使用到的画图软件。
...
![Excalidraw](http://blog.xiebiao.com/images/2021-11-22-plantuml-c4/asciiflow.png "图片来自网络")

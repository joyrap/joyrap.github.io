...
$$ C=\sum\_{p}c\_{p}t\_{p} $$ （p为系统的组件数量，c为组件的复杂性，t为完成组件投入的时间）
...
> 作者用了Deep和Shallow两个概念来描述模块接口与功能的设计，非常形象，
...
## 19. Software Trends<软件规范>
### 19.1 Object-oriented programming and inheritance<面向对象编程与继承>

在面向对象编程中，继承有两种形式：
一种是接口间继承，接口继承目的在于多个实现间复用相同接口，从而降低复杂性。
